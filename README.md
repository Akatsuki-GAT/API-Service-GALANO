1. NAME and put all of these in a folder can be named anything as long it's under C -> xampp -> htdocs -> insert the listed files in here: [YOUR_FOLDER NAME]
2. Some features such as fruity.html won't work without xampp's Apache as its feature is block for an unknown reason if there's no PHP
...
4. Make sure Apache is running (for fruity or API - 3 only)
